...
<main class="flex-grow pt-20 pb-10">
    <div class="container mx-auto px-4 max-w-md">
        <div class="bg-dark-light rounded-xl p-8 shadow-lg">
            <h1 class="text-3xl font-bold mb-8 text-center text-primary">加入 GameTalk</h1>
            <form action="RegisterServlet" method="post" class="space-y-6">
                ...
                <div>
                    <label for="email" class="block text-text-muted mb-2">邮箱</label>
                    <input type="email" id="email" name="email" required 
                        class="w-full bg-dark border border-gray-700 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50">
                </div>
                <div class="flex justify-between items-center">
                    <a href="login.jsp" class="text-secondary hover:text-secondary/80 text-sm">已有账号？立即登录</a>
                    <button type="submit" 
